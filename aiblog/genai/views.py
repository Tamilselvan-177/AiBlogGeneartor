...
API_KEY = "AIzaSyBwNDnAvOMcc0PyE57xeqw1YQ68I0hZrPo"
...
def get_gemini_response(topic):
    try:
        response = requests.post(
            ...
            json={
                "contents": [{"parts": [{"text": f"Generate 1 random quiz question on {topic} with four options and indicate the correct answer in JSON format."}]}]
            },
        ...
        return ai_response.get("candidates", [{}])[0].get("content", {}).get("parts", [{}])[0].get("text", "No response from AI")
